#!/usr/bin/env python3
"""
Fetch research topics from ethresear.ch (Discourse API).

Usage:
    python3 tools/fetch-ethresearch.py                          # fetch all categories
    python3 tools/fetch-ethresearch.py --category proof-of-stake
    python3 tools/fetch-ethresearch.py --search "verkle tries"
    python3 tools/fetch-ethresearch.py --limit 100

Output goes to data/ethresearch/<category>/<topic-id>.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Fetch ethresear.ch topics")
    parser.add_argument("--category", help="Category slug (e.g., proof-of-stake, evm)")
